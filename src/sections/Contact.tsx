        ...
        <div className="absolute inset-0  opacity-5 -z-10" style={{backgroundImage: `url(${grainImage.src})`}}></div>
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-20">
            <div>
              ...
              <p className="mt-3 text-gray-950 font-medium text-center md:text-lg md:text-start">Ready to bring your next project to life? Lets connect and I can help you achieve your goals.</p>
            </div>
